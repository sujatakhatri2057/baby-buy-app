...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        emailfromlogin = getIntent().getExtras().getString("Email");
    ...
    //load user fragment on call with data
    public void loadUserFragment() {
        UserFragment usf = new UserFragment();
        Bundle b = new Bundle();
        b.putString("Email1", emailfromlogin);
        usf.setArguments(b);
        FragmentManager fm = getSupportFragmentManager();
        FragmentTransaction ft = fm.beginTransaction();
        ft.replace(R.id.f_container, usf);
        ft.commit();
    }
